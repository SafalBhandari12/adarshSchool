      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center'>
          ...
          <div className='space-y-6 sm:space-y-8'>
            <div className='space-y-4 sm:space-y-6'>
              ...
              <div className='space-y-3 sm:space-y-4 text-gray-700 text-base sm:text-lg leading-relaxed max-w-lg'>
                <p>
              ...
              <div className='pt-4 sm:pt-6'>
                <button className='flex items-center space-x-3 text-dusty-rose hover:text-teal-gray transition-colors group'>
                  ...
                  <div className='w-12 sm:w-16 h-px bg-dusty-rose group-hover:w-16 sm:group-hover:w-20 transition-all duration-300'></div>
                  <svg
        ...
        <div className='mt-16 sm:mt-20 lg:mt-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
          <div className='text-center p-6 sm:p-8 rounded-xl bg-gradient-to-br from-cream/50 to-white'>
            <div className='text-3xl sm:text-4xl font-bold text-dusty-rose mb-2'>
              12+
            </div>
