...
export default function DomeGallery({
  ...
  maxRadius = Infinity,
  padFactor = 0.05,
  overlayBlurColor = "rgba(214, 169, 157, 0.1)",
  ...
  const cssStyles = `
    ...
    .item__image:hover {
      ...
      box-shadow: 0 15px 35px rgba(214, 169, 157, 0.25), 0 8px 20px rgba(0, 0, 0, 0.15);
      border-color: rgba(214, 169, 157, 0.4);
    }
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className='absolute inset-0 m-auto z-[3] pointer-events-none opacity-10'
            style={{
              backgroundImage: `radial-gradient(ellipse at center, rgba(255, 255, 255, 0) 40%, rgba(214, 169, 157, 0.05) 70%, rgba(214, 169, 157, 0.1) 100%)`,
            }}
          />
          ...
          <div
            className='absolute inset-0 m-auto z-[3] pointer-events-none opacity-10'
            style={{
              WebkitMaskImage: `radial-gradient(ellipse at center, rgba(255, 255, 255, 0) 50%, rgba(214, 169, 157, 0.05) 80%)`,
              maskImage: `radial-gradient(ellipse at center, rgba(255, 255, 255, 0) 50%, rgba(214, 169, 157, 0.05) 80%)`,
          ...
          {/* Top fade blur edge */}
          <div
            className='absolute left-0 right-0 top-0 h-[120px] z-[5] pointer-events-none'
            style={{
              background: `linear-gradient(to bottom, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.6) 30%, rgba(255, 255, 255, 0.2) 70%, transparent 100%)`,
          ...
          {/* Bottom fade blur edge */}
          <div
            className='absolute left-0 right-0 bottom-0 h-[120px] z-[5] pointer-events-none'
            style={{
              background: `linear-gradient(to top, rgba(255, 255, 255, 0.9) 0%, rgba(255, 255, 255, 0.6) 30%, rgba(255, 255, 255, 0.2) 70%, transparent 100%)`,
              backdropFilter: "blur(1px)",
